...
import { createLocalidad, deactivateLocalidad, listLocalidades, updateLocalidad, type LocalidadInput, type LocalidadUpdateInput } from "@/data/models/localidades.model";
